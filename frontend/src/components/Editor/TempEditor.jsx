...
//   const id = "66d051a0c4501065efe6915c"
...
//         content: blog.data.contnet
//       })
//       setImage(p => ({ ...p, url: blog.data.photo }))
//     }
//   }, [blog]);
...
//     (blogData) => {
//       if (id) {
//         return updateBlog(id, blogData); // Update existing post
//       } else {
//         return createBlog(blogData); // Create new post
//       }
//     },
//     {
//       onSuccess: (data) => {
...
//     }).then(async () => {
//       imgMutation.mutate({ file: image.file, customName: id }, {
//         onSuccess: (data) => {
//           // setBlogData(p => ({ ...p, photo: data }))
...
//       try {
//         await editorRef.current.render(blog.data.content);
...
//           <textarea className="text-sm sm:text-base  font-details w-full theme-text theme-bg outline-none  font-title font-bold"
